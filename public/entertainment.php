		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				...
				<?php 
					...
					<li class="colorlib-active"><a href="entertainment.php">Entertainment</a></li>
				...
				<div class="container">
					<div class="row px-md-4">
						...
						<?php
	    					...
	    					$sql3 = "SELECT * FROM created_post WHERE category = 'Entertainment' limit $limit offset $offset";
