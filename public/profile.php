<?php require_once('../includes/header2.php');?>
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
	      ...
	      <div class="row d-flex mb-5 contact-info">
	      	<form action="../includes/edit.php" method="post" class="bg-light p-5 contact-form" enctype="multipart/form-data">
				...
				<div class="form-group">
					<img src="../includes/profilepic/<?php echo $image;?>" class="img img-circle img-responsive" id="profile_img_tag" width="200" height="200">
				</div>
				<div class="form-group">
	        ...
	        <div class="col-md-6">
				...
				<p>click on the edit button to activate input fields</p>
					<form action="../includes/edit.php" method="post" class="bg-light p-5 contact-form">
						<div class="form-group">
							<label>Email</label>
