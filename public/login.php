		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="login.php">Login / Register</a></li>
				</ul>
			</nav>
				...
				<div class="container">
					<div class="row px-md-4">
						<div class="col-md-12">
							...
							<div class="login-box">
								<form action="../includes/loginsub.php" method="post" class="bg-light p-5 contact-form">
					        ...
					        <div class="register-box">
								<form action="../includes/registersub.php" method="post" class="bg-light p-5 contact-form" enctype="multipart/form-data">
								<div class="form-group">
							<?php
							if (isset($_GET['error'])) {?>
								<div class="alert alert-danger"><?=urldecode($_GET['error'])?></div>
